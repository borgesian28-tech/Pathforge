    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(160deg, #0a0a0a 0%, #1a1a2e 50%, #0a0a0a 100%)', padding: 20 }}>
        <div style={{ maxWidth: 520, width: '100%' }} className="fade-in">
          ...
          <button onClick={function() { setSelectedMajor(''); setCustomMajor(''); setStep(4); }} style={{ marginTop: 8, padding: '10px 20px', borderRadius: 8, border: '1px solid #2a2a3e', background: 'transparent', color: '#6a6a7a', fontSize: 13, fontWeight: 600, cursor: 'pointer', width: '100%' }}>Skip — let AI recommend a major</button>
        </div>
      </div>
    );
  }
