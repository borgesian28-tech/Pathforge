        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 8 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              }} style={{ background: btnBg, backdropFilter: 'blur(10px)', border: 'none', color: '#fff', padding: '8px 12px', borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>📄 Export</button>
              <button onClick={function() {
              ...
              }} style={{ background: btnBg, backdropFilter: 'blur(10px)', border: 'none', color: '#fff', padding: '8px 12px', borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>📋 Share</button>
